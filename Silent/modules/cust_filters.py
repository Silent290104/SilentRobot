...
from Silent import LOGGER as log
from Silent import dispatcher
from Silent.modules.connection import connected
from Silent.modules.helper_funcs.alternate import send_message, typing_action
from Silent.modules.helper_funcs.decorators import Silentcallback, Silentcmd, Silentmsg
from Silent.modules.helper_funcs.extraction import extract_text
from Silent.modules.helper_funcs.filters import CustomFilters
from Silent.modules.helper_funcs.misc import build_keyboard_parser
from Silent.modules.helper_funcs.msg_types import get_filter_type
from Silent.modules.helper_funcs.string_handling import (
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
    split_quotes,
)
from Silent.modules.sql import cust_filters_sql as sql
...
@typing_action
@Silentcmd(command="filters", admin_ok=True)
...
@Silentcmd(command="filter", run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@Silentcmd(command="stop", run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@Silentmsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@Silentcmd(command="removeallfilters", filters=Filters.chat_type.groups)
...
@Silentcallback(pattern=r"filters_.*")
