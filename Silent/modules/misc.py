...
import Silent.modules.sql.users_sql as sql
from Silent import DEMONS as SUPPORT_USERS
from Silent import DEV_USERS
from Silent import DRAGONS as SUDO_USERS
from Silent import INFOPIC, OWNER_ID
from Silent import OWNER_USERNAME as AKBOSS
from Silent import TIGERS
from Silent import WOLVES as WHITELIST_USERS
from Silent import StartTime, dispatcher, sw
from Silent.__main__ import STATS, USER_INFO
from Silent.modules.disable import DisableAbleCommandHandler
from Silent.modules.helper_funcs.chat_status import sudo_plus, user_admin
from Silent.modules.helper_funcs.decorators import Silentcmd
from Silent.modules.helper_funcs.extraction import extract_user
from Silent.modules.users import __user_info__ as chat_count
...
@Silentcmd(command="info", pass_args=True)
...
def get_user_info(chat: Chat, user: User) -> str:
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\n<code>ᴍᴇᴍʙᴇʀ ᴏғ sɪʟᴇɴᴛ ᴛᴇᴄʜ, ᴛᴏᴛᴀʟʟʏ ᴄᴏᴏʟ ʀɪɢʜᴛ ?</code>"
        disaster_level_present = True
    if disaster_level_present:
        text += ' [<a href="https://t.me/Silent_Smile_04 /60">?</a>]'
    text += "\n"
...
@Silentcmd(command="markdownhelp", filters=Filters.chat_type.private)
...
@Silentcmd(command="stats", can_disable=False)
@sudo_plus
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + "\n\n[ɢɪᴛʜᴜʙ](https://github.com/Wolf2901/SilentRobot) | [ᴛᴇʟᴇɢʀᴀᴍ](https://t.me/Silent_Smile_04)\n\n"
            + f"「 ʙʏ[sɪʟᴇɴᴛ](t.me/{SILENTBOSS}) 」\n",
