...
import Silent.modules.sql.userinfo_sql as sql
...
@Silentcmd(command="me", pass_args=True)
...
@Silentcmd(command="bio", pass_args=True)
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000, 5278339583] and sender_id not in DEV_USERS:
