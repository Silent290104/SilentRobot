...
from Silent import LOGGER, updater
...
from Silent.modules.helper_funcs.decorators import Silentcallback, Silentcmd
...
@Silentcmd(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@Silentcallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Silentcallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Silentcallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@Silentcmd(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
