...
import Silent.modules.sql.blacklist_sql as blacklistsql
import Silent.modules.sql.locks_sql as locksql
import Silent.modules.sql.notes_sql as sql
import Silent.modules.sql.rules_sql as rulessql
from Silent import EVENT_LOGS as JOIN_LOGGER
from Silent import LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from Silent.__main__ import DATA_IMPORT
from Silent.modules.connection import connected
from Silent.modules.helper_funcs.alternate import typing_action
from Silent.modules.helper_funcs.chat_status import user_admin
from Silent.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("SilentRobot{}Backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SilentRobot{}Backup".format(chat_id), "rb"),
    ...
    os.remove("Silent{}Backup".format(chat_id))  # Cleaning file
