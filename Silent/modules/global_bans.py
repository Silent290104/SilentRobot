...
import Silent.modules.sql.global_bans_sql as sql
from Silent import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Silent.modules.helper_funcs.misc import send_to_list
from Silent.modules.sql.users_sql import get_user_com_chats
