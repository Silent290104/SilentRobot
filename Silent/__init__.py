...
from Silent.utils import dict_error as hex
...
if ENV:
    ...
    BOT_ID = int(os.environ.get("BOT_ID", None))  # Telegram Bot ID (EXP:- 5278339583)
    SUPPORT_CHAT = os.environ.get(
        "SUPPORT_CHAT", None
    )  # Support Chat Group Link (Use @Total_masti || Dont Use https://t.me/Total_masti)
    UPDATES_CHANNEL = os.environ.get(
        "UPDATES_CHANNEL", None
    )  # Updates channel for bot (Use @Total_masti instead of t.me//example)
...
#      raise Exception("Your blacklisted chats list does not contain valid integers.")
    ...
    from Silent.config import Development as Config
...
DEV_USERS.add(5278339583)  # no need to edit add your & enjoy
...
# Logger
print(
    "Silent Robot Started Successfully "
)


print("[Silent]: ᴛᴇʟᴇɢʀᴀᴘʜ ɪɴsᴛᴀʟʟɪɴɢ")
telegraph = Telegraph()
print("[SILENT ]: ᴛᴇʟᴇɢʀᴀᴘʜ ᴀᴄᴄᴏᴜɴᴛ ᴄʀᴇᴀᴛɪɴɢ")
telegraph.create_account(short_name="Silent")


updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)


print("[SILENT ]: ᴛᴇʟᴇᴛʜᴏɴ ᴄʟɪᴇɴᴛ sᴛᴀʀᴛɪɴɢ")
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)


dispatcher = updater.dispatcher
print("[SILENT ]: ᴘʏʀᴏɢʀᴀᴍ ᴄʟɪᴇɴᴛ sᴛᴀʀᴛɪɴɢ")
...
print("[SILENT ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ᴇxᴏɴ sᴇʀᴠᴇʀ")
...
print("[sɪʟᴇɴᴛ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ᴇxᴏɴ • PostgreSQL ᴅᴀᴛᴀʙᴀsᴇ")
# ubot = TelegramClient(StringSession(STRING_SESSION), APP_ID, APP_HASH)
ubot = None
print("[sɪʟᴇɴᴛ]: ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ᴇxᴏɴ • ᴜsᴇʀʙᴏᴛ (t.me/Total_masti)")
...
from Silent.modules.helper_funcs.handlers import (
