...
from Silent.modules import ALL_MODULES
...
from Silent.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Silent.modules.{module_name}")
    ...
    if query.data == "Silent_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="⬅️", callback_data="Silent_prev"),
                        InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Silent_back"),
                        InlineKeyboardButton(text="➡️", callback_data="Silent_next"),
                    ]
                ]
            ),
        )
...
""",
    ...
    data_callback_handler = CallbackQueryHandler(
        Silent_callback_data, pattern=r"Silent_", run_async=True
    )
